<%@ Page Language="C#" AutoEventWireup="true" CodeFile="confirmed.aspx.cs" Inherits="confirmed" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" href="dashboard.aspx" 
             onclick="LinkButton1_Click">Back to Dashboard</asp:LinkButton>
</center>
    </div>
    </div>
    </form>
